...
def calc_loss(buffer, batch_size, env, action, policy_noise, noise_clip, actor, qf1, qf2, target_actor, qf1_target, qf2_target, actor_optimizer, q_optimizer, gamma, tau, max_grad_norm, global_step, policy_frequency, writer, device):
