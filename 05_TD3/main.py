...
if __name__ == "__main__":
    ...
    for global_step in range(1, args.total_timesteps + 1):
        ...
        if global_step > args.learning_starts:
            qf1_loss, qf2_loss, actor_loss = calc_loss(rb, args.batch_size, env, action, args.policy_noise, args.noise_clip, actor, qf1, qf2, target_actor, qf1_target, qf2_target, actor_optimizer,
